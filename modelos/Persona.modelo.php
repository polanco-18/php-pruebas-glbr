...
class ModeloPersona{
    ...
    static public function mdlIngresarPersona($tabla,$datos){ 
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(ID_PERSONA,TIPO_DOCUMENTO,NACIONALIDAD,NOMBRE,APELLIDO_P,APELLIDO_M,SEXO,FECHA_NACIMIENTO,CORREO, TELEFONO,CELULAR) VALUES(:ID_PERSONA,:TIPO_DOCUMENTO,:NACIONALIDAD,:NOMBRE,:APELLIDO_P,:APELLIDO_M,:SEXO,:FECHA_NACIMIENTO,:CORREO,:TELEFONO,:CELULAR)");
    ...
    static public function mdlEditarPersona($tabla,$datos){ 
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET NOMBRE=:NOMBRE,APELLIDO_P=:APELLIDO_P,APELLIDO_M=:APELLIDO_M,SEXO=:SEXO,FECHA_NACIMIENTO=:FECHA_NACIMIENTO,CORREO_INST=:CORREO_INST,CORREO=:CORREO,TELEFONO=:TELEFONO, CELULAR=:CELULAR  WHERE ID_PERSONA=:ID_PERSONA");  
        $stmt -> bindParam(":ID_PERSONA",$datos["ID_PERSONA"],PDO::PARAM_STR); 
        $stmt -> bindParam(":NOMBRE",$datos["NOMBRE"],PDO::PARAM_STR);
        $stmt -> bindParam(":APELLIDO_P",$datos["APELLIDO_P"],PDO::PARAM_STR);
        $stmt -> bindParam(":APELLIDO_M",$datos["APELLIDO_M"],PDO::PARAM_STR);
        $stmt -> bindParam(":SEXO",$datos["SEXO"],PDO::PARAM_STR);
        $stmt -> bindParam(":FECHA_NACIMIENTO",$datos["FECHA_NACIMIENTO"],PDO::PARAM_STR);
        $stmt -> bindParam(":CORREO_INST",$datos["CORREO_INST"],PDO::PARAM_STR);
        $stmt -> bindParam(":CORREO",$datos["CORREO"],PDO::PARAM_STR); 
        $stmt -> bindParam(":TELEFONO",$datos["TELEFONO"],PDO::PARAM_STR);
        $stmt -> bindParam(":CELULAR",$datos["CELULAR"],PDO::PARAM_STR);  
        if($stmt->execute()){
